...
def parse_command_line():
    ...
    parser02.add_argument(
        ...
        action='store',
        nargs='+',
        choices=['pot', 'po', 'html', 'pdf', 'epub', 'all'],
...
def main():
    ...
    if 'language' in vars(args):
        if args.language == 'all':
            ...
            process_languages = get_languages()
